(defproject musicmath "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "musicmath.core/on-js-reload"
                ...
                :compiler {:main musicmath.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/musicmath.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/musicmath.js"
                           :main musicmath.core
